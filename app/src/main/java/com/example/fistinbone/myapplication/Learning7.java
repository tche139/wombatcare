...
/**
 * Created by fistinbone on 8/28/2017.
 */

public class Learning7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new Learning7.ScreenSlidePagerAdapter(getSupportFragmentManager());
