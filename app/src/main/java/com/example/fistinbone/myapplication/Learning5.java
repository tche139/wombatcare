...
import com.example.fistinbone.myapplication.Fragment.ScreenSlidePageFragment3;
...
public class Learning5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new Learning5.ScreenSlidePagerAdapter(getSupportFragmentManager());
