...
public class Learning4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new Learning4.ScreenSlidePagerAdapter(getSupportFragmentManager());
    ...
    public class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        @Override
        //read the position and move ti the right page
